        ...
        <div className="carousel w-full h-[300px] md:h-[650px]">
            <div id="slide1" className="carousel-item relative w-full">
                <div className="w-full relative flex justify-start items-center">
                    ...
                    <div className="bg-gradient-to-r from-orange-200 to-transparent dark:from-orange-800 h-full w-full pt-20 md:pt-4 pb-6 pl-4 md:pl-10 lg:pl-32 backdrop-blur-none rounded-lg flex flex-col items-center md:items-start justify-center gap-3 md:gap-8">
