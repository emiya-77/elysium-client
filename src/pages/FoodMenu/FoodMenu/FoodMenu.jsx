...
const FoodMenu = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/food-menu?page=${currentPage}&size=${itemsPerPage}`)
            .then(res => res.json())
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="container mx-auto my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-5">
                {
                    query
            ...
            <div>
                <div className='container mx-auto p-3 rounded-lg bg-orange-100 flex pagination justify-center gap-5 mb-10 shadow-lg'>
                    ...
                    <select className="px-4 rounded-lg shadow-md focus:outline-none" value={itemsPerPage} onChange={handleItemsPerPage}>
